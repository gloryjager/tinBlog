...
class MessageboardsControllerTest < ActionController::TestCase
  ...
  test "should create messageboard" do
    assert_difference('Messageboard.count') do
      post :create, messageboard: { body: @messageboard.body, createdat: @messageboard.createdat, title: @messageboard.title }
    end
  ...
  test "should update messageboard" do
    patch :update, id: @messageboard, messageboard: { body: @messageboard.body, createdat: @messageboard.createdat, title: @messageboard.title }
    assert_redirected_to messageboard_path(assigns(:messageboard))
  end
